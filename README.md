...
4. A Temporal schedule nudges the ensemble agent every 30 seconds to evaluate active symbols.
5. The ensemble agent approves intents with `pre_trade_risk_check`, then
