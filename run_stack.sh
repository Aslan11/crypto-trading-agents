...
# ├───────────────┼────────────────────────┤
# │ Pane 6        │ Pane 7                 │
# │ ensemble_agent_client.py │ crypto_ticker_ui.py    │
# └────────────────────────────────────────┘
###############################################################################
...
tmux send-keys    -t $UI_PANE 'sleep 2 && source .venv/bin/activate && PYTHONPATH="$PWD" python agents/crypto_ticker_ui.py' C-m
