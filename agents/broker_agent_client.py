...
SYSTEM_PROMPT = (
    ...
    "When user provides comma-separated preferences like '33%, 10%, 10%, aggressive':\n"
    "Parse as: position_size_comfort, cash_reserve_level, drawdown_tolerance, trading_style\n"
    ...
    "You: Ask follow-up questions about position sizing, cash reserves, drawdown tolerance, trading style\n"
    "User: '33%, 10%, 10%, aggressive'\n"
